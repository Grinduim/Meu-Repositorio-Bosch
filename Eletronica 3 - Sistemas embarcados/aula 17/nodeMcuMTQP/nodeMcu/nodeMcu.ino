...
#define TOPICO_PUBLISH   "Treinamento/ets/grupo1"    //tópico MQTT de envio de informações para Broker
                                                   //IMPORTANTE: recomendamos fortemente alterar os nomes
                                                   //            desses tópicos. Caso contrário, há grandes
                                                   //            chances de você controlar e monitorar o NodeMCU
                                                   //            de outra pessoa.
#define ID_MQTT  "ViniciuseNathan"     //id mqtt (para identificação de sessão)
